...
### Do not use short colour description like "fff" instead of '0a0a0a'. It will confuse you over time.
...
### with the newcolour but anything white (0a0a0a) will never change.
### Only folder places

find . -name "*.svg" -type f -exec sed -i 's/fill="#'$oldcolour'"/fill="#'$newcolour'"/g' {}  \;
find . -name "*.svg" -type f -exec sed -i 's/fill:#'$oldcolour'/fill:#'$newcolour'/g' {}  \;
find . -name "*.svg" -type f -exec sed -i 's/stroke="#'$oldcolour'"/stroke="#'$newcolour'"/g' {}  \;
find . -name "*.svg" -type f -exec sed -i 's/stroke:#'$oldcolour'/stroke:#'$newcolour'/g' {}  \;
